...
class RDE(nn.Module):
    def __init__(self, args, num_classes=11003):
        ...
        if 'TAL' in self.current_task:
            ...
            loss_type = 'SDM'
        elif 'SRCM' in self.current_task:
            loss_type = 'SRCM'
        elif 'GSCA' in self.current_task:
            loss_type = 'GSCA'    
        else:
            exit()
    ...
    def forward(self, batch):
        ...
        loss1, loss2, loss3, loss4 = objectives.compute_rbs(i_feats, t_feats, i_tse_f, t_tse_f, batch['pids'], \
